...
namespace NcoVAppUpdate.Droid
{
    ...
    //{
    //    private readonly string TotalCases = "";
    //    private readonly string ActiveCases = "";
    //    private readonly string Recoveries = "";
    //    private readonly string Deaths = "";
    //    private readonly string NewTotalCases = "";
    //    private readonly string NewDeaths = "";
    //    private readonly string UpdateTime = "";
    //    public const string ID = "69421";

    //    private NotificationCompat.Builder mBuilder;
    //    private readonly NotificationCompat.BigTextStyle textStyle = new NotificationCompat.BigTextStyle();
    ...
    //            var notificationChannel = new NotificationChannel(ID, "title", importance);
    ...
    //    {
    //        //var client = new RestClient(string.Format("https://covid-193.p.rapidapi.com/statistics?country={0}", "Philippines"));
